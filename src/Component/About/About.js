...
function About() {
  return (
    <>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8 sptb">
                ...
                <p className="leading-normal-2">
                  There are many variations of passages of Lorem Ipsum
                  available, but the majority have suffered by injected humour,
                  or randomised words which don't look even slightly believable.
                  If you are going to use a passage of Lorem Ipsum It is a long
                  established fact that a reader will be distracted by the
                  readable of a page when looking at its layout. as opposed to
                ...
                <h4 className="font-weight-semibold2 mt-6 mb-4">Our Gallery</h4>
                <div className="owl-carousel owl-carousel-icons52">
                  <div className="item">
                    <div className="text-center br-5 overflow-hidden">
                      <a className href="#">
                        <img
                          src="../../assets/images/categories/category/1.png"
                          alt="img"
                          className="br-tl-5 br-tr-5"
                        />
                      </a>
                      <h6 className="mb-0 p-3 border border-top-0 br-bl-5 br-br-5">
                        Place 01
                      </h6>
                    </div>
                  </div>
      ...
      <section className="sptb">
        <div className="container">
          <div className="section-title center-block text-center">
            <span className="heading-style text-secondary">How</span>
            <h2>It Works?</h2>
            <p>
          ...
          <div className="row service-time-line-main">
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="service-timeline">
                <div className="mb-lg-0 mb-4">
                  <div className="service-card text-center">
                    <div className="bg-primary icon-bg  icon-service text-purple about service-card-svg">
                      {/* Register Svg*/}
                      <svg
                        height="482pt"
                        viewBox="-15 0 482 482.60407"
                        width="482pt"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <path d="m268.941406 173.949219h25.609375c3.3125 0 6-2.6875 6-6 0-3.316407-2.6875-6-6-6h-25.609375c-3.316406 0-6 2.683593-6 6 0 3.3125 2.683594 6 6 6zm0 0" />
                        <path d="m156.160156 173.949219h89.820313c3.316406 0 6-2.6875 6-6 0-3.316407-2.683594-6-6-6h-89.820313c-3.3125 0-6 2.683593-6 6 0 3.3125 2.6875 6 6 6zm0 0" />
                        <path d="m94.542969 173.949219h38.199219c3.3125 0 6-2.6875 6-6 0-3.316407-2.6875-6-6-6h-38.199219c-3.316407 0-6 2.683593-6 6 0 3.3125 2.683593 6 6 6zm0 0" />
                        <path d="m231.722656 214.8125h-106.386718c-3.316407 0-6 2.6875-6 6s2.683593 6 6 6h106.386718c3.3125 0 6-2.6875 6-6s-2.6875-6-6-6zm0 0" />
                        <path d="m94.542969 226.8125h11.136719c3.3125 0 6-2.6875 6-6s-2.6875-6-6-6h-11.136719c-3.316407 0-6 2.6875-6 6s2.683593 6 6 6zm0 0" />
                        <path d="m94.542969 282.972656h71.257812c3.316407 0 6-2.6875 6-6s-2.683593-6-6-6h-71.257812c-3.316407 0-6 2.6875-6 6s2.683593 6 6 6zm0 0" />
                        <path d="m123.347656 322.875h-28.804687c-3.316407 0-6 2.6875-6 6 0 3.316406 2.683593 6 6 6h28.804687c3.3125 0 6-2.683594 6-6 0-3.3125-2.6875-6-6-6zm0 0" />
                    ...
                    <div className="servic-data mt-3">
                      <h4 className="font-weight-semibold mb-0">Register</h4>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="service-timeline">
                <div className="mb-lg-0 mb-4">
                  <div className="service-card text-center">
                    <div className="bg-secondary icon-bg  icon-service text-purple about service-card-svg">
                      {/* Create account Svg*/}
                      <svg
                        height="618pt"
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="service-timeline">
                <div className>
                  <div className="service-card text-center">
                    <div className="bg-success icon-bg  icon-service text-purple about service-card-svg">
                      {/* Earnings Svg*/}
                      <svg
                        id="Layer_1"
                        height={512}
      ...
      <section>
        <div
          className="cover-image pt-10 pb-10 bg-background2 bg-background-color-dark"
          data-image-src="../../assets/images/banners/banner11.jpg"
        >
          <div className="content-text mb-0">
            <div className="container">
              <div className="row">
                <div className="col-md-7">
                  <div className="text-white">
                    <h2 className="mb-2 display-5 font-weight-semibold2 leading-normal">
                      Are you ready for the posting your tours on this Site?
                    </h2>
                    <p className="fs-16 leading-loose">
                      There are many variations of passages of Lorem Ipsum
                    ...
                    <div className="mt-6">
                      <a
                        href="add-post.html"
                        className="btn btn-lg btn-secondary px-7"
                      >
                        Free Post Ad
                      </a>
                    </div>
      ...
      <section className="sptb bg-white">
        <div className="container">
          <div className="section-title center-block text-center">
            <span className="heading-style text-secondary">Why</span>
            <h2>Choose Us</h2>
            <p>
          ...
          <div className="item-all-cat center-block text-center">
            <div className="row">
              <div className="col-lg-4 col-md-12">
                <div className="status-border mb-4 mb-lg-0 p-5 pt-5 card">
                  <div>
                    <div className="status-info text-center">
                      <div className="cat-img category-svg d-block bg-primary-transparent">
                        <i className="fa fa-thumbs-o-up fs-30 text-primary icon-lineheight" />
                      </div>
                      <h4 className="mt-5 mb-2 fs-20 font-weight-semibold2">
              ...
              <div className="col-lg-4 col-md-12">
                <div className="status-border mb-4 mb-lg-0 p-5 pt-5 card">
                  <div>
                    <div className="status-info text-center">
                      <div className="cat-img category-svg d-block bg-success-transparent">
                        <i className="fa fa-shield fs-30 text-success icon-lineheight" />
                      </div>
                      <h4 className="mt-5 mb-2 fs-20 font-weight-semibold2">
                        Travellers Security
                      </h4>
              ...
              <div className="col-lg-4 col-md-12">
                <div className="status-border p-5 pt-5 card mb-0">
                  <div>
                    <div className="status-info text-center">
                      <div className="cat-img category-svg d-block  bg-warning-transparent">
                        <i className="fa fa-headphones fs-30 text-warning icon-lineheight" />
                      </div>
                      <h4 className="mt-5 mb-2 fs-20 font-weight-semibold2">
                        24/7 Support
                      </h4>
          ...
          <div className="row">
            <div className="col-lg-4 col-xl-4 col-md-12">
              <div className="card mb-lg-0 overflow-hidden">
                <div className="item-card7-imgs">
                  <img
                    src="../../assets/images/faces/guide-04.jpg"
                    alt="img"
                    className="mx-auto"
                  />
                </div>
                <div className="card-body">
                  <div className="item-card7-desc">
                    <div className="item-card7-text d-flex">
                      <a href="userprofile.html.html" className="text-dark">
                        <h5 className="font-weight-bold">Lilly Wisely</h5>
                      </a>
                      <div className="star-ratings start-ratings-main clearfix ml-auto d-flex">
                        <div className="stars stars-example-fontawesome stars-example-fontawesome-sm mr-1">
                          <select
                    ...
                    <div className="border-bottom pb-4 mb-4 border-dashed border-top-0 border-left-0 border-right-0">
                      <a href="#" className="pr-3 mr-2 border-right">
                        <span className>
                          <i className="fe fe-briefcase mr-1" /> CEO
                        </span>
                      </a>
                      <a href="#" className="pr-3 mr-2">
                        <span className>
                          <i className="fe fe-map-pin mr-1" /> Canada
                        </span>
                      </a>
                    </div>
                    <p className>
                    ...
                    <div className="d-flex">
                      <a className="p-2 text-primary fs-18" href>
                        <i className="fa fa-facebook" />
                      </a>
                      <a className="p-2 text-secondary fs-18" href>
                        <i className="fa fa-twitter" />
                      </a>
                      <a className="p-2 text-success fs-18" href>
                        <i className="fa fa-rss" />
                      </a>
                      <a className="p-2 text-info fs-18" href>
            ...
            <div className="col-lg-4 col-xl-4 col-md-12">
              <div className="card mb-lg-0 overflow-hidden">
                <div className="item-card7-imgs">
                  <img
                    src="../../assets/images/faces/guide-02.jpg"
                    alt="img"
                    className="mx-auto"
                  />
                </div>
                <div className="card-body">
                  <div className="item-card7-desc">
                    ...
                    <div className="border-bottom pb-4 mb-4 border-dashed border-top-0 border-left-0 border-right-0">
                      <a href="#" className="pr-3 mr-2 border-right">
                        <span className>
                          <i className="fe fe-briefcase mr-1" /> HR Manager
                        </span>
                      </a>
                      <a href="#" className="pr-3 mr-2">
                        <span className>
                          <i className="fe fe-map-pin mr-1" /> Spain
                        </span>
                      </a>
                    </div>
                    <p className>
            ...
            <div className="col-lg-4 col-xl-4 col-md-12">
              <div className="card mb-0 overflow-hidden">
                <div className="item-card7-imgs">
                  <img
                    src="../../assets/images/faces/guide-03.jpg"
                    alt="img"
                    className="mx-auto"
                  />
                </div>
                <div className="card-body">
                  <div className="item-card7-desc">
                    <div className="item-card7-text d-flex">
                      <a href="userprofile.html.html" className="text-dark">
                        <h5 className="font-weight-bold">Rebaca Mary</h5>
                      </a>
                      <div className="star-ratings start-ratings-main clearfix ml-auto d-flex">
                        <div className="stars stars-example-fontawesome stars-example-fontawesome-sm mr-1">
                          <select
                    ...
                    <div className="border-bottom pb-4 mb-4 border-dashed border-top-0 border-left-0 border-right-0">
                      <a href="#" className="pr-3 mr-2 border-right">
                        <span className>
                          <i className="fe fe-briefcase mr-1" /> Director
                        </span>
                      </a>
                      <a href="#" className="pr-3 mr-2">
                        <span className>
                          <i className="fe fe-map-pin mr-1" /> France
                        </span>
                      </a>
                    </div>
                    <p className>
      ...
      <section className="sptb position-relative">
        <div className="container">
          <div className="section-title center-block text-center pb-5">
            <span className="heading-style text-secondary">What Our</span>
          ...
          <div className="row">
            <div className="col-md-12">
              <div
                id="myCarousel"
                className="owl-carousel testimonial-owl-carousel"
              >
                <div className="item text-center pt-0">
                  <div className="row">
                    <div className="col-xl-8 col-md-12 d-block mx-auto">
                      <div className>
                        <div className="owl-controls clickable mt-0 mb-4">
                        ...
                        <p className>
                          <i className="fa fa-quote-left" /> Lorem ipsum dolor
                          sit amet, consectetur adipisicing elit. Quod eos id
                          officiis hic tenetur quae quaerat ad velit ab. Lorem
                          ipsum dolor sit amet, consectetur adipisicing elit.
                          Dolore cum accusamus eveniet molestias voluptatum
                          inventore laboriosam labore sit, aspernatur
                          praesentium iste impedit quidem dolor veniam.
                        </p>
                        <h3 className="title mb-1 fs-18 font-weight-semibold2">
                          Elizabeth
                        </h3>
                  ...
                  <div className="row">
                    <div className="col-xl-8 col-md-12 d-block mx-auto">
                      <div className>
                        ...
                        <p className>
                          <i className="fa fa-quote-left" /> Nemo enim ipsam
                  ...
                  <div className="row">
                    <div className="col-xl-8 col-md-12 d-block mx-auto">
                      <div className>
                        ...
                        <p className>
                          <i className="fa fa-quote-left" /> Duis aute irure
