      ...
      <div className="horizontal-main header-transparent clearfix py-lg-3">
        <div className="horizontal-mainwrapper container clearfix">
          <div className="desktoplogo">
            <a href="index.html">
              <img src="../../assets/images/brand/condoasia1.png" alt="" />
            </a>
          </div>
          <div className="desktoplogo-1">
            <a href="index.html">
              <img src="../../assets/images/brand/condoasia2.png" alt="" />
            </a>
          </div>
          <nav className="horizontalMenu clearfix d-md-flex">
            <ul className="horizontalMenu-list">
              <li>
                <a href="#">
                  Home <span className="fa fa-caret-down m-0"></span>
                </a>
              ...
              <li>
                <a href="#">
                  Categories <span className="fa fa-caret-down m-0"></span>
                </a>
                <ul className="sub-menu">
                  <li>
                    <a href="#">
                    ...
                    <ul className="sub-menu">
                      ...
                      <li>
                        ...
                        <ul className="sub-menu">
                          ...
                          <li>
                            <a href="cruises-list-map.html">Cruises List Map</a>
                          </li>
                        </ul>
                      </li>
                      <li>
              ...
              <li>
                <a href="#">
                  Features <span className="fa fa-caret-down m-0"></span>
                </a>
                <ul className="sub-menu">
                  <li>
                    <a href="#">
              ...
              <li>
                <a href="#">
                  Pages <span className="fa fa-caret-down m-0"></span>
                </a>
                    ...
                    <div className="megamenu-content">
                      <div className="row">
                        ...
                        <ul className="col link-list">
                          ...
                          <li>
                            <a href="page-success.html"> Success Alert Page</a>
                          </li>
                          <li>
                            <a href="page-warning.html"> Warning Alert Page</a>
                          </li>
                          <li>
              ...
              <li>
                <a href="#">
                  Blog <span className="fa fa-caret-down m-0"></span>
                </a>
                <ul className="sub-menu">
                  <li>
                    <a href="#">
                  ...
                  <li>
                    ...
                    <ul className="sub-menu">
                      ...
                      <li>
                        <a href="blog-details-right.html">Blog Details Right</a>
                      </li>
                      <li>
              ...
              <li className="">
                <span>
                  <a className="btn btn-secondary" href="add-post.html">
                    <i className="fe fe-plus"></i> Add Post
                  </a>
                </span>
              </li>
            </ul>
